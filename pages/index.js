      ...
      <main className={styles.container}>
        <div className={styles.gallery}>
          <div className={styles.img}>
            <Image src="/1.jpg" width={700} height={1050} alt="img" layout="responsive"/>
          </div>

          <div className={styles.img}>
            <Image src="/3.jpg" width={700} height={1050} alt="img" layout="responsive"/>
          </div>
        ...
        <div className={styles.about}>
          ...
          <Image src="/8.jpg" width={700} height={1050} alt="img" layout="responsive"/>
          </div>
        </div>
